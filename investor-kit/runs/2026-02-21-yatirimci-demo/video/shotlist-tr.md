# MuPark Tanitim Videosu Shot List

## Teknik

- Sure: 60-90 sn
- Oran: 16:9 (YouTube, toplanti) + 9:16 cutdown (sosyal medya)
- Cozunurluk: 1920x1080

## Sahne Plani

| # | Sure | Gorsel | Ekran Yazi | Seslendirme Bolumu |
|---|---|---|---|---|
| 1 | 0-8 sn | Sehir trafigi + park arayan arac | "Park yeri aramak zaman kaybettiriyor." | Giris |
...
- [ ] Logo (SVG + PNG)
- [ ] Uygulama ekran kaydi
- [ ] Dashboard ekran kaydi
- [ ] Sehir ve park stok videolari
- [ ] Telifsiz muzik
- [ ] Final seslendirme dosyasi (WAV)
- [ ] Altyazi dosyasi (SRT)
