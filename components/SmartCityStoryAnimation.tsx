  ...
  const copy = useMemo(
    () => ({
      tr: {
        ...
        title: "Ok tuslariyla oynayan akilli park hikayesi",
        desc:
          "Bu sahne, akilli sehir teknolojisinin icinde akilli park sisteminin nasil calistigini cizgi film tadinda adim adim anlatir. Saga ve sola basarak hikayeyi ilerletebilirsiniz.",
        steps: [
          {
            title: "Surucu park ariyor",
            detail: "Arac sehir icinde uygun park yeri bulmak icin zaman kaybediyor.",
            note: "Sorun: zaman, trafik ve yakit kaybi",
          },
          {
            title: "Kamera karakterleri dolulugu okuyor",
            detail: "Akilli kameralar bos ve dolu alanlari sahada anlik tespit ediyor.",
            note: "Algilama: doluluk, ihlal, hareket",
          },
          {
            title: "AI en uygun yeri secip yonlendiriyor",
            detail: "Yapay zeka bos yeri secip surucuyu rezervasyon akisina tasiyor.",
            note: "Karar: en yakin ve en verimli park noktasi",
          },
          {
            title: "Belediye sehri veriyle yonetiyor",
            detail: "Yonetim paneli doluluk, rezervasyon ve saha verisini tek ekranda goruyor.",
            note: "Sonuc: daha akici, olculebilir, akilli sehir",
          },
        ],
        panelLabel: "Belediye kontrol merkezi",
        panelInfo: "Doluluk, rezervasyon ve yonlendirme ayni panelde.",
        parkingLabel: "Akilli park slotlari",
        parkingState: ["Dolu", "Bos", "Rezerve"],
        cityLabel: "Akilli sehir akisi",
        reservationPopup: "Rezervasyon Onaylandi",
        reservationSub: "P-03 sizin icin ayrildi",
        prev: "Geri",
        next: "Ileri",
        progress: "Adim",
      },
